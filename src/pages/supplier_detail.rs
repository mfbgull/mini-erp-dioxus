                ...
                rsx! {
                    ...
                    if *active_tab.read() == 1 {
                        div { class: "supplier-section",
                            div { class: "supplier-section-header",
                                h2 { "Purchase Orders" }
                                Button { variant: ButtonVariant::Primary, onclick: { let mut t = toast.clone(); move |_| t.info("Coming Soon", "New PO creation coming soon.") }, "＋ New PO" }
                            }
                            if orders.is_empty() {
                    ...
                    div { class: "supplier-actions",
                        div { class: "supplier-actions-left",
                            ...
                            Button { variant: ButtonVariant::Secondary, onclick: { let mut t = toast.clone(); move |_| t.info("Coming Soon", "New PO creation coming soon.") }, icon: Some("📋".to_string()), "New Purchase Order" }
                        }
