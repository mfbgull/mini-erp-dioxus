...
.top-menu { display: flex; align-items: center; justify-content: space-between; height: 52px; padding: 0 20px; background: #fff; border-bottom: 1px solid var(--border-color, #e0e0e0); position: sticky; top: 0; z-index: 50; }
...
.top-menu-search { display: flex; align-items: center; gap: 6px; padding: 6px 12px; border: 1px solid var(--border-color, #e0e0e0); border-radius: 8px; background: var(--bg-muted, #f5f5f5); cursor: pointer; font-size: 13px; color: var(--text-secondary); min-width: 200px; }
.top-menu-search kbd { padding: 1px 5px; background: #fff; border: 1px solid var(--border-color); border-radius: 3px; font-size: 11px; margin-left: auto; }
...
.top-menu-btn:hover { background: var(--bg-hover, #f0f0f0); }
...
.top-menu-user:hover { background: var(--bg-hover, #f0f0f0); }
.top-menu-avatar { width: 28px; height: 28px; border-radius: 50%; background: var(--accent, #4a90d9); color: #fff; display: flex; align-items: center; justify-content: center; font-size: 12px; font-weight: 600; }
"#;
